...
$numberofslides = theme_debonsix_get_setting('numberofslides');
  ...
  <div id="home-page-carousel" class="carousel slide" data-ride="carousel" data-interval= "2000">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        for($s1 = 1; $s1 <= $numberofslides; $s1++):
            $clstxt2 = ($s1 == "1") ? ' active' : '';
            $slidecaption = theme_debonsix_get_setting('slide' . $s1 . 'caption', true);
            $slideimg = theme_debonsix_render_slideimg($s1, 'slide' . $s1 . 'image');
            $icon = "fa-angle-right";
            if (right_to_left()) {
                $icon = "fa-angle-left";
            }
            $slidebtn = theme_debonsix_get_setting('slide'.$s1.'urltext');
            $slidebtn = theme_debonsix_lang($slidebtn);
            $slideurl = theme_debonsix_get_setting('slide' . $s1 . 'url');
            //$readmore = get_string("readmore", "theme_debonsix");
