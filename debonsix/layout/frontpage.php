...
$html = theme_debonsix_get_html_for_settings($OUTPUT, $PAGE);
...
<div class="">
    <?php
        $toggleslideshow = theme_debonsix_get_setting('toggleslideshow');
    ...
    <?php
    $whotitle = theme_debonsix_get_setting('whoweare_title');
    $whodesc = theme_debonsix_get_setting('whoweare_description');
